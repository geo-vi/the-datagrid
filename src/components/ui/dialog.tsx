  ...
  <DialogPortal>
    <div className="tdg-dialog-portal" data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        style={style}
        className={cn(
          "tdg-dialog-content z-50 grid w-full max-w-lg gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:rounded-lg",
          className
        )}
        {...props}
      >
