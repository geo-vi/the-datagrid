...
export function HeaderCell(props: HeaderCellProps) {
  ...
  return (
    <TableHead
      ...
      className={cn(
        "tdg-header-cell InovuaReactDataGrid__column-header sticky top-0 z-20 border-b bg-[var(--tdg-header-bg)] [border-color:var(--tdg-header-border-color)] [color:var(--tdg-header-color)]",
